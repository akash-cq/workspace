...
const twoFactorAuthExpireTime_Seconds = 60 * 5;
...
const emailContent = {
  ...
  [emailType.twofactorAuth]: {
    subject: "CodeQuotient Discussion Portal - 2FA Verification",
    content: renderTemplateFile("twofactorAuth"),
  },
};
...
module.exports = {
    ...
    twoFactorAuthExpireTime_Seconds,
    cqBackendRoutes,
